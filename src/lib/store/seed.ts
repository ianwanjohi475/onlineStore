...
export const seed: StoreData = {
  ...
  settings: {
    ...
    heroSlides: [
      { id: "slide-1", slug: "watch-nova-am", eyebrow: "Wearables", title: "Watch Nova AM", subtitle: "", copy: "AMOLED · on-wrist calling · 10-day battery", buttonText: "Shop now", buttonLink: "/product/watch-nova-am", from: "#111827", to: "#0b1220", overlay: 0, active: true },
      { id: "slide-2", slug: "powerbank-q21", eyebrow: "Power that lasts", title: "Powerbank Q21", subtitle: "", copy: "20,000mAh · 22.5W fast charge · digital display", buttonText: "Shop now", buttonLink: "/product/powerbank-q21", from: "#0a1a3f", to: "#0b1220", overlay: 0, active: true },
      { id: "slide-3", slug: "boompop-pro", eyebrow: "Turn it up", title: "BoomPop Pro", subtitle: "", copy: "20W stereo · deep bass · IPX6 splash-proof", buttonText: "Shop now", buttonLink: "/product/boompop-pro", from: "#2a1633", to: "#141018", overlay: 0, active: true },
      { id: "slide-4", slug: "services", eyebrow: "Networking services", title: "Fibre, WiFi & PC repair", subtitle: "", copy: "Fibre splicing · WiFi installation · router config · PC repair", buttonText: "Explore services", buttonLink: "/services", from: "#0b2b3a", to: "#0b1220", overlay: 0, active: true },
    ],
